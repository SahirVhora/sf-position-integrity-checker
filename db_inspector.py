...
SAMPLES = {
    "extract_meta": {
        ...
        "queries": [
            ("All extract runs",
             "SELECT * FROM extract_meta ORDER BY id DESC;"),
    ...
    "fo_company": {
        ...
        "queries": [
            ...
            ("Row count",
             "SELECT COUNT(*) AS total FROM fo_company;"),
        ],
    },
    "fo_business_unit": {
        ...
        "queries": [
            ("Row count",
             "SELECT COUNT(*) AS total FROM fo_business_unit;"),
            ("All business units",
    ...
    "fo_division": {
        ...
        "queries": [
            ("Row count",
             "SELECT COUNT(*) AS total FROM fo_division;"),
            ("All divisions",
    ...
    "fo_department": {
        ...
        "queries": [
            ("Row count",
             "SELECT COUNT(*) AS total FROM fo_department;"),
    ...
    "cust_sub_department": {
        ...
        "queries": [
            ("Row count",
             "SELECT COUNT(*) AS total FROM cust_sub_department;"),
    ...
    "fo_job_code": {
        ...
        "queries": [
            ("Row count",
             "SELECT COUNT(*) AS total FROM fo_job_code;"),
    ...
    "fo_job_class_local_can": {
        ...
        "queries": [
            ("Row count",
             "SELECT COUNT(*) AS total FROM fo_job_class_local_can;"),
    ...
    "fo_cost_center": {
        ...
        "queries": [
            ("Row count",
             "SELECT COUNT(*) AS total FROM fo_cost_center;"),
            ("All cost centres",
    ...
    "fo_location": {
        ...
        "queries": [
            ("Row count",
             "SELECT COUNT(*) AS total FROM fo_location;"),
            ("All locations",
